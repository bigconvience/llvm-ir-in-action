...
int main(int argc, char *argv[]) {
  ...
  Value *stack = Builder.CreateAlloca(Type::getInt32Ty(Context), nullptr, "stack");
  Value *temp0 = Builder.CreateAdd(reg, Builder.getInt32(2), "temp");
  Value *temp1 = Builder.CreateAdd(reg, Builder.getInt32(1), "temp");

  Builder.CreateRet(temp1);
